        ...
        data.map(function(val, index) {
            row += `
                <tr>
                   ...
                   <td>${rupiah(val.grand_total)}</td>
                   <td>
                        <a href="#" data-id="${val.id}" class="btn btn-success btn-aksi-process">Proses</a>
                    </td>
                </tr>
            `;
        });
...
// $(document).on('click','.btn-aksi-process',function(){
//     const id = $(this).data('id');
//     const confirm_dialog = confirm('Apakah Anda yakin ingin memproses pesanan ini?');
//     if (confirm_dialog) {
